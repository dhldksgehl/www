...
<body>
    <div id="wrap">
    <h1><a href="../index.html" class="logo">CJ푸드빌</a></h1>
	<article id="content">
        <div id="col2">
                    ...
                    <div id="id_input_button">
                        <fieldset>
                               ...
                               <div class="telBox">
                                   ...
                                   <input class="find_input hp" type="text" id="hp2" name="hp2" title="연락처 가운데3자리를 입력하세요." maxlength="4" placeholder="(ex. 1111)"> ㅡ
                           ...
                           <!-- <ul class="go">
                               ...
                               <li><a href="pw_find.php">비밀번호찾기</a></li>
                           </ul> -->
        
                            <ul class="btn_wrap btn_wrap2 member_btn_wrap">
                                <li><a href="login_form.php" class="btn" role="button">로그인하기</a></li>
                                <li><a href="pw_find.php" class="btn" role="button">비밀번호찾기</a></li>
                            </ul>
                    </div>
                    <div class="clear"></div>
