                    ...
                    <div id="id_input_button">
                        <fieldset>
                               ...
                               <div class="telBox">
                                   ...
                                   <input class="find_input hp" type="text" id="hp2" name="hp2" title="연락처 가운데3자리를 입력하세요." maxlength="4" placeholder="(ex. 1111)" required> ㅡ
                           ...
                           <ul class="btn_wrap btn_wrap2 member_btn_wrap">
                                       ...
                                       <li><a href="id_find.php" class="btn" role="button">아이디찾기</a></li>
                           </ul>
                    </div>
                    <div class="clear"></div>
