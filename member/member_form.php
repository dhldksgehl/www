...
<body>
    <header>
        <h1><a href="../index.html">CJ푸드빌</a></h1>
    </header>
    ...
    if(!$userid){
    ?>
                <input type="text" name="id" id="id" placeholder="foodville01" maxlength="41" required>
                <div id="loadtext"></div>  
        <?
            }else{
        ?>
        ...
        ?>
            ...
            <div class="row">
                ...
                <input type="text" name="nick" id="nick" placeholder="푸드빌" required>
            ...
            <div class="row">
                ...
                <input type="text" id="email1" name="email1" class="mail member_mail" placeholder="foodville" required>
                <span class="symbol">@</span>
                <label class="hidden" for="email2">이메일주소</label>
                <input type="text" name="email2" id="email2" class="mail member_mail" placeholder="foodville.co.kr" required>
                <div id="loadtext"></div>  
            </div>
